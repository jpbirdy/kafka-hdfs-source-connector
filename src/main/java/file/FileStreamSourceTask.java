 ...
 * @class FileStreamSourceTask
 * @date 17/5/12 22:57
 * @desc FileStreamSourceTask reads from stdin or a file.
 */

public class FileStreamSourceTask extends SourceTask {
  private static final Logger log = LoggerFactory
      .getLogger(FileStreamSourceTask.class);
  ...
  public void start(Map<String, String> props) {
    ...
    if (topic == null)
      throw new ConnectException(
          "FileStreamSourceTask config missing topic setting");
  }
      ...
      try {
        ...
        if (offset != null) {
          ...
          if (lastRecordedOffset != null &&
              !(lastRecordedOffset instanceof Long))
          ...
          streamOffset = (lastRecordedOffset !=
              null) ? (Long) lastRecordedOffset : 0L;
        }
        else {
          streamOffset = 0L;
        }
        ...
        log.warn(
            "Couldn't find file {} for FileStreamSourceTask, sleeping to wait for it to be created",
            logFilename());
        synchronized (this) {
          this.wait(1000);
        }
          ...
          do {
            ...
            if (line != null) {
              ...
              records.add(new SourceRecord(offsetKey(filename),
                  offsetValue(streamOffset), topic, null, null, null,
                  VALUE_SCHEMA, line, System.currentTimeMillis()));
            }
          } while (line != null);
        }
      }
